...
def var_suppressed(feature):
    if feature in X.columns:
        ...
        test_df_with_predictions['dnn_score'] = y_pred_proba
        ...
        # Apply the cut
        events_passing_cut = test_df_with_predictions[test_df_with_predictions['dnn_score'] > cut_value]
        ...
        plt.title(f'Effect of DNN Cut on {feature} Distribution', fontsize=16)
        plt.legend()
        plt.show()
...
var_suppressed('cosTBTO')
var_suppressed('cosTBz')
var_suppressed('foxWolframR2')